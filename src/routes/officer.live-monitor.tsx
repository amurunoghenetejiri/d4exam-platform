              ...
              {selected.hasLiveVideo && selected.frame?.src ? (
                ...
                <>
                  ...
                  <div className="flex h-full flex-col items-center justify-center gap-2 px-4 text-center text-white">
                    ...
                    <p className="text-[11px] text-white/70">{selected.isDone ? "This student finished. Card leaves after 10 minutes." : selected.presence.cameraActive ? "Live frames appear when the student camera is streaming. Nothing is recorded." : "Student camera is off or unavailable. Offline cards leave after 3 minutes."}</p>
                  </div>
                </>
              )}
            </div>
