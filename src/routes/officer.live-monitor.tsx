                ...
                {selected.hasLiveVideo && selected.frame?.src ? (
                  ...
                  <>
                    ...
                    <div className="flex h-full flex-col items-center justify-center gap-1.5 px-4 text-center text-white">
                      {selected.isDone ? <CheckCircle2 className="h-9 w-9 text-emerald-400/80" /> : selected.presence.cameraActive ? <UserRound className="h-9 w-9 opacity-40" /> : <CameraOff className="h-9 w-9 opacity-40" />}
