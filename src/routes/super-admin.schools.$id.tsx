      ...
      <div className="mb-4 flex flex-wrap items-center gap-4 rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
        ...
        <div className="flex flex-wrap gap-2">
          <Button
            ...
            disabled={mgmtBusy || school.status === "active"}
            onClick={() => void setSchoolStatus("active", "Restore this school to active?")}
          >
            Restore
          </Button>
          <Button
            ...
            disabled={mgmtBusy || school.status === "suspended"}
            onClick={() => void setSchoolStatus("suspended", "Suspend this school? Users will be restricted.")}
          >
            Suspend
          </Button>
          <Button
            ...
            disabled={mgmtBusy || school.status === "blocked"}
            onClick={() => void setSchoolStatus("blocked", "Block this school?")}
          >
            Block
          </Button>
          <Button
            ...
            disabled={mgmtBusy || school.status === "revoked"}
            onClick={() =>
              void setSchoolStatus("revoked", "Revoke this school permanently? School ID will not be reused.")
            }
          >
            Revoke
          </Button>
