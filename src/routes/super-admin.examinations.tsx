...
export const Route = createFileRoute("/super-admin/examinations")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Examinations delivered across the platform." },
      { property: "og:title", content: "Examinations — D4EXAM" },
      { property: "og:description", content: "Examinations delivered across the platform." },
    ],
  }),
  component: Page,
});
...
function Page() {
  return (
    <DbRecordsPage
      title="Examinations"
      description="Examinations delivered across the platform."
      table="examinations"
