-- =============================================================================
-- D4EXAM — Notifications (run this in Supabase SQL Editor if not already applied)
-- Makes: table, indexes, RLS, insert_notification RPC, realtime publication
-- =============================================================================
...
-- SELECT: own notifications (or school admin / super admin)
...
-- INSERT: any signed-in user can notify another user
...
-- SECURITY DEFINER insert (bypasses RLS edge cases)
...
EXCEPTION
  WHEN undefined_object THEN
    NULL; -- publication may not exist in some envs
END $$;
